...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { first: @instructor.first, id: @instructor.id, last: @instructor.last } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { first: @instructor.first, id: @instructor.id, last: @instructor.last } }
